...
function graph(resinRun){
    ...
    if(toggled){
        document.getElementById("flex").innerHTML ="<div id='head-percentage'><b><font color='#B14715'>Combined</font></b> chance of getting an artifact: </div> <div id='percentage'>" +roundedPercent +"% </div>";
